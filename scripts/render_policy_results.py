...
def section(source,evidence,out,table,fmt,esc,svg):
    ...
    parts=['<section id="policy"><h2>Aktuelle Regeln · PF 1,05 · DD-Zeit höchstens 16 Stunden</h2>',
        table(['Regel','Sollwert / Modell','Status'],[
            ...
            ['Live-Ausführung','Block → Active; Normal (General) disabled; bis zu 80 qualifizierte Sets','Neue Source-Installation weiterhin durch automatische Freigabeprüfung blockiert. Keine erzwungene Auffüllung.']]),
